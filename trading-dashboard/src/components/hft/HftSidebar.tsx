...
import { formatCurrency, formatPercentage } from '../../services/hftApiService';
...
const HftSidebar: React.FC<HftSidebarProps> = ({ botData, onStartBot, onStopBot, onRefresh }) => {
